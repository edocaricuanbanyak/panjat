...
export const copyId = {
  ...
  manjat: {
    ...
    gambarLabel: "URL gambar (opsional)",
    gambarPlaceholder: "https://…/foto.jpg",
    gambarHint: "Foto/logo untuk kartu — mis. foto profil IG/TikTok. Kosongkan untuk deteksi otomatis.",
    lanjut: "Lanjut",
    kembali: "Kembali",
  ...
  statistik: {
    ...
    klikTotal: "Total klik disalurkan",
    klikTotalMetode: "Dihitung di server tiap ada yang klik link, sejak papan dibuka. Klik berulang dari orang yang sama dalam 6 jam tidak dihitung dobel.",
    cpc: "CPC rata-rata",
