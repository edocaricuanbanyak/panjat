...
// Wednesday 17:00 cut-off: board #1/#2/#3 (by grip), the week's Terfavorit, and
// the Kaki Tiang champion (most Sorak). One row per (week, kind). Feeds the
// archive page, the featured showcase, and the weekly Threads/TikTok card.
